...
void ABOIPlayerController::SetupInputComponent()
{
	...
	InputComponent->BindAction("SetDestination", IE_Pressed, this, &ABOIPlayerController::OnSetDestinationPressed);
	InputComponent->BindAction("SetDestination", IE_Released, this, &ABOIPlayerController::OnSetDestinationReleased);
